...
public class DataDummy {
    ...
    static {
        ...
        TRACK_1 = new TrackEntity(1L, "test-1", "lyrics-1");
        TRACK_2 = new TrackEntity(2L, "test-2", "lyrics-2");
        TRACK_3 = new TrackEntity(3L, "test-3", "lyrics-3");
        TRACK_4 = new TrackEntity(4L, "test-4", "lyrics-4");
        TRACK_5 = new TrackEntity(5L, "test-5", "lyrics-5");
        RECORD_COMPANY = new RecordCompanyEntity("test-company-records");
